...
def getRecommendationForPlanRest (userID, City):
    csvRestInfo = r"../TravelRecommeder_Flask/Plan/Allrestaurants2.csv"
    timesCsv = r"../TravelRecommeder_Flask/Plan/Allrestaurants3.csv"
    timesSpark = spark.read.csv(timesCsv, header=True)
    csvRatingInfoRest = r'../TravelRecommeder_Flask/Restaurants/user_profiling_rest.csv'
...
def formatRecommendations (city,id):
    ...
    attractions_data = pd.read_csv(r'../TravelRecommeder_Flask/attractions_reccommendation/attractions.csv')
    ratings_data = pd.read_csv(r'../TravelRecommeder_Flask/attractions_reccommendation/user_profiling3010.csv')
    ...
    timesAttract = pd.read_csv(r'../TravelRecommeder_Flask/attractions_reccommendation/Attractions open hours.csv')
